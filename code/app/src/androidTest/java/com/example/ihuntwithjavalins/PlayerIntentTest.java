 ...
 * TODO: Make it so that these tests passes without logging in prior on your machine OR that the test machine has logged in
 *
 * @version 1.0
 */
...
public class PlayerIntentTest {
    ...
    public void setUp() throws Exception {
        ...
        //InstrumentationRegistry instumentation = new InstrumentationReg
        ...
        // savedDeviceUser = mPrefs.getString("UsernameTag", "default_username_not_found");
    ...
    /**
     * Navigates to the players profile and checks for sum of their scores is kept as Total Points:
     * US 01.05.01
     */
    @Test
    public void totalScore() throws InterruptedException {
        solo.assertCurrentActivity("Wrong Activity", QuickNavActivity.class);
        solo.clickOnView(solo.getView(R.id.button_qn_profile));
        solo.assertCurrentActivity("Wrong Activity", ProfileActivity.class);
        solo.searchText("1000",1);
    ...
    /**
     * Navigates to the players profile and checks for the total codes a player has
     * US 01.06.01
     */
    @Test
